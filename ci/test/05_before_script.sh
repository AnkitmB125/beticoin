...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/beticoin
else
  DOCKER_EXEC echo \> \$HOME/.beticoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/beticoin/beticoin/pull/18288#discussion_r433189350 for
  # details.
