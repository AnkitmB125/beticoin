...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef beticoin_CHAINPARAMSSEEDS_H\n')
    g.write('#define beticoin_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the beticoin network\n')
    ...
    g.write('#endif // beticoin_CHAINPARAMSSEEDS_H\n')
