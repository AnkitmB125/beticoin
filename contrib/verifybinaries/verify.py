...
beticoincore.org and beticoin.org and compares them.
...
WORKINGDIR = "/tmp/beticoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://beticoincore.org"
HOST2 = "https://beticoin.org"
VERSIONPREFIX = "beticoin-core-"
...
def main(args):
    ...
    if not success:
        print("beticoin.org failed to provide signature file, "
              "but beticoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("beticoin.org and beticoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the beticoin Core binary release "
