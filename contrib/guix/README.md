# Bootstrappable beticoin Core Builds

This directory contains the files necessary to perform bootstrappable beticoin
Core builds.
...
From the top of a clean beticoin Core repository:
...
To use dongcarl's substitute server for beticoin Core builds after having
