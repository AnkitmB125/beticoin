#!/bin/sh
# Copyright (c) 2017-2019 The beticoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the beticoin repository."
  exit 1
fi
...
# See https://github.com/beticoin/beticoin/issues/16064
...
echo 'When compiling beticoind, run `./configure` in the following way:'
echo
