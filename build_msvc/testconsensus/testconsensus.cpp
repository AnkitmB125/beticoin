...
// beticoin includes.
#include <..\src\script\beticoinconsensus.h>
...
int main()
{
    std::cout << "beticoinconsensus version: " << beticoinconsensus_version() << std::endl;
    ...
    auto op0Result = beticoinconsensus_verify_script_with_amount(pubKeyScript.data(), pubKeyScript.size(), amount, stream.data(), stream.size(), 0, beticoinconsensus_SCRIPT_FLAGS_VERIFY_ALL, &err);
