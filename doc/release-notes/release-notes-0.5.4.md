beticoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/beticoin/files/beticoin/beticoin-0.5.4/
...
http://gitorious.org/beticoin/beticoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix beticoin-Qt notifications under Growl 1.3.
Increase required age of beticoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxbeticoin properly when installing beticoin-Qt over it. (Windows)
