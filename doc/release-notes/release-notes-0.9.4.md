beticoin Core version 0.9.4 is now available from:

  https://beticoin.org/bin/0.9.4/
...
this update is incompatible with the beticoin system and could lead to consensus
forks.

beticoin Core released binaries from https://beticoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~beticoin/+archive/ubuntu/beticoin
- A third-party or self-compiled beticoin Core

upgrade to beticoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
