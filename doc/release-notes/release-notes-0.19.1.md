...
beticoin Core version 0.19.1 is now available from:

  <https://beticoincore.org/bin/beticoin-core-0.19.1/>
...
From beticoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as beticoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, beticoin Core does not yet change appearance when
...
- #17488 fix "beticoind already running" warnings on macOS (fanquake)
