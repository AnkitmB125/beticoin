beticoin Core version 0.10.4 is now available from:

  <https://beticoin.org/bin/beticoin-core-0.10.4/>
...
- #6953 `43c2789` Split beticoin-tx into its own package
- #6953 `dfe0d4d` Include beticoin-tx binary on Debian/Ubuntu
