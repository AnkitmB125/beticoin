beticoin Core version *0.14.3* is now available from:

  <https://beticoin.org/bin/beticoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/beticoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
