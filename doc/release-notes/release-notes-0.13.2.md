beticoin Core version 0.13.2 is now available from:

  <https://beticoin.org/bin/beticoin-core-0.13.2/>
...
- #8908 `4a974b2` Update beticoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow beticoin-tx to create v2 transactions (btcdrak)
