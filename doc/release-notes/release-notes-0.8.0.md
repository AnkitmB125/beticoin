beticoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/beticoin/files/beticoin/beticoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the beticoin
...
New/changed settings (command-line or beticoin.conf file)
--------------------------------------------------------
