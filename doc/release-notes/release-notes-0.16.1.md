beticoin Core version 0.16.1 is now available from:

  <https://beticoincore.org/bin/beticoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting beticoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure beticoind processes are cleaned up when tests end (sdaftuar)
