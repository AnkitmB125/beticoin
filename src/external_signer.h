// Copyright (c) 2018-2021 The beticoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef beticoin_EXTERNAL_SIGNER_H
#define beticoin_EXTERNAL_SIGNER_H
...
#endif // beticoin_EXTERNAL_SIGNER_H
