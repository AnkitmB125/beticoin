...
#ifndef beticoin_PROTOCOL_H
#define beticoin_PROTOCOL_H
...
/**
 * beticoin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all beticoin Core non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // beticoin Core nodes used to support this by default, without advertising this bit,
    ...
    // beticoin-development mailing list. Remember that service bits are just
