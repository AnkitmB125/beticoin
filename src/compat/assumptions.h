...
#ifndef beticoin_COMPAT_ASSUMPTIONS_H
#define beticoin_COMPAT_ASSUMPTIONS_H
...
#if defined(NDEBUG)
# error "beticoin cannot be compiled without assertions."
#endif
...
#endif // beticoin_COMPAT_ASSUMPTIONS_H
