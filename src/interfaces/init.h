...
#ifndef beticoin_INTERFACES_INIT_H
#define beticoin_INTERFACES_INIT_H
...
//! (beticoin-gui, beticoin-node, beticoin-wallet, beticoind, beticoin-qt) and each
...
#endif // beticoin_INTERFACES_INIT_H
