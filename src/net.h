...
#ifndef beticoin_NET_H
#define beticoin_NET_H
 ...
 * src/qt/guiutil.cpp and src/beticoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on beticoin’s Peer-to-Peer Network")
