...
#ifndef beticoin_WALLET_WALLETUTIL_H
#define beticoin_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! beticoin from opening the wallet, thinking it was newly created, and
...
#endif // beticoin_WALLET_WALLETUTIL_H
