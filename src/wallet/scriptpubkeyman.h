...
#ifndef beticoin_WALLET_SCRIPTPUBKEYMAN_H
#define beticoin_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The beticoin Core wallet was originally a collection of unrelated private
...
#endif // beticoin_WALLET_SCRIPTPUBKEYMAN_H
