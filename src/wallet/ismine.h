...
#ifndef beticoin_WALLET_ISMINE_H
#define beticoin_WALLET_ISMINE_H
 ...
 * https://github.com/beticoin/beticoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // beticoin_WALLET_ISMINE_H
