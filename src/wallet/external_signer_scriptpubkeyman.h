...
#ifndef beticoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define beticoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // beticoin_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
