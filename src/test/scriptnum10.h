...
#ifndef beticoin_TEST_SCRIPTNUM10_H
#define beticoin_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from beticoin Core 0.10.0, for cross-comparison.
 */
public:
