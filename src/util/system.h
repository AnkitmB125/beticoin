 ...
 */
#ifndef beticoin_UTIL_SYSTEM_H
#define beticoin_UTIL_SYSTEM_H
...
extern const char * const beticoin_CONF_FILENAME;
extern const char * const beticoin_SETTINGS_FILENAME;
