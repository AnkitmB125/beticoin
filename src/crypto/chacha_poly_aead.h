...
#ifndef beticoin_CRYPTO_CHACHA_POLY_AEAD_H
#define beticoin_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@beticoin.
 *
 ...
 *
 * The chacha20-poly1305@beticoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@beticoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@beticoin are relatively fast in
...
#endif // beticoin_CRYPTO_CHACHA_POLY_AEAD_H
