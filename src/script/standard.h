...
#ifndef beticoin_SCRIPT_STANDARD_H
#define beticoin_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a beticoin address
 */
...
/**
 * Generate a beticoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // beticoin_SCRIPT_STANDARD_H
