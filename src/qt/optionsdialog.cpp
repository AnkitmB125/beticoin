    ...
    mapper(nullptr)
{
    ...
    ui->beticoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->beticoinAtStartup);
    ...
    ui->beticoinAtStartup->setToolTip(ui->beticoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->beticoinAtStartup->setText(ui->beticoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openbeticoinConfButton->setToolTip(ui->openbeticoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new beticoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->beticoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openbeticoinConfButton_clicked()
{
