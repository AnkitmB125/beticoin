...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<beticoinAmountField*>("payAmount")->setValue(amount);
...
//
//     QT_QPA_PLATFORM=xcb     src/qt/test/test_beticoin-qt  # Linux
//     QT_QPA_PLATFORM=windows src/qt/test/test_beticoin-qt  # Windows
//     QT_QPA_PLATFORM=cocoa   src/qt/test/test_beticoin-qt  # macOS
void TestGUI(interfaces::Node& node)
{
...

    {
        ...
        QString balanceComparison = beticoinUnits::formatWithUnit(unit, balance, false, beticoinUnits::SeparatorStyle::ALWAYS);
    ...
    // Amount input
    beticoinAmountField* amountInput = receiveCoinsDialog.findChild<beticoinAmountField*>("reqAmount");
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'QT_QPA_PLATFORM=cocoa test_beticoin-qt' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI(m_node);
