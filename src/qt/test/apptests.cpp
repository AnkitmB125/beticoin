...
//! Entry point for beticoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &beticoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for beticoinGUI tests.
void AppTests::guiTests(beticoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &beticoinGUI::consoleShown, this, &AppTests::consoleTests);
