...
#ifndef beticoin_QT_RECEIVECOINSDIALOG_H
#define beticoin_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of beticoins */
...
#endif // beticoin_QT_RECEIVECOINSDIALOG_H
