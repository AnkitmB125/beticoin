...
#ifndef beticoin_QT_GUIUTIL_H
#define beticoin_QT_GUIUTIL_H
...
/** Utility functions used by the beticoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "beticoin:" URI into recipient object, return true on successful parsing
