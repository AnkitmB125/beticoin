    ...
    platformStyle(_platformStyle)
{
    ...
    // normal beticoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying beticoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &beticoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
