...
WalletFrame::WalletFrame(const PlatformStyle* _platformStyle, beticoinGUI* _gui)
    : QFrame(_gui),
      gui(_gui),
...
bool WalletFrame::addWallet(WalletModel *walletModel)
{
    ...
    connect(walletView, &WalletView::transactionClicked, gui, &beticoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::coinsSent, gui, &beticoinGUI::gotoHistoryPage);
    connect(walletView, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        gui->message(title, message, style);
    });
    connect(walletView, &WalletView::encryptionStatusChanged, gui, &beticoinGUI::updateWalletStatus);
    connect(walletView, &WalletView::incomingTransaction, gui, &beticoinGUI::incomingTransaction);
    connect(walletView, &WalletView::hdEnabledStatusChanged, gui, &beticoinGUI::updateWalletStatus);
    connect(gui, &beticoinGUI::setPrivacy, walletView, &WalletView::setPrivacy);
