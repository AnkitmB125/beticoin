...
#ifndef beticoin_CHAINPARAMSBASE_H
#define beticoin_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between beticoin-cli and beticoind)
 * of a given instance of the beticoin system.
 */
...
#endif // beticoin_CHAINPARAMSBASE_H
