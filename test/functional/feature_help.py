...
"""Verify that starting beticoin with -h works as expected."""

from test_framework.test_framework import beticoinTestFramework
from test_framework.util import assert_equal

class HelpTest(beticoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start beticoin with -h for help text")
        ...
        self.log.info("Start beticoin with -version for version information")
        ...
        self.log.info("Start beticoind with -fakearg to make sure it does not start")
