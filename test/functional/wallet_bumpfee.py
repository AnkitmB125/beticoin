...
class BumpFeeTest(beticoinTestFramework):
    ...
    def run_test(self):
        ...
        # fund rbf node with 10 coins of 0.001 btc (100,000 betishis)
...
def test_dust_to_fee(self, rbf_node, dest_address):
    ...
    # The DER formatting used by beticoin to serialize ECDSA signatures means that signatures can have a
