...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the beticoinTestFramework
    pass


class ExampleTest(beticoinTestFramework):
    # Each functional test is a subclass of the beticoinTestFramework class.
    ...
    def custom_method(self):
        ...
        beticoinTestFramework class so other tests can use it."""
