...
class WalletSendTest(beticoinTestFramework):
    def set_test_params(self):
        ...
        getcontext().prec = 8 # betishi precision for Decimal
    ...
    def run_test(self):
        ...
        self.test_send(from_wallet=w0, to_wallet=w1, amount=1, change_address="not an address",
                       expect_error=(-5, "Change address must be a valid beticoin address"))
