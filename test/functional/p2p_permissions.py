...
class P2PPermissionsTests(beticoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].beticoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].beticoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
