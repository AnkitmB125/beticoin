...
class TestShell:
    """Wrapper Class for beticoinTestFramework.

    The TestShell class extends the beticoinTestFramework
    ...
    class __TestShell(beticoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by beticoinTestFramework child class.
            self.num_nodes = 1
