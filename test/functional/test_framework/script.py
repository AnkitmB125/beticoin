...
This file is modified from python-beticoinlib.
"""
...
def bn2vch(v):
    """Convert number to beticoin-specific little endian format."""
...
def FindAndDelete(script, sig):
    """Consensus critical, see FindAndDelete() in betishi codebase"""
    r = b''
