...
class TestbeticoinCli(beticoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `beticoin-cli getblockchaininfo`")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and beticoin-cli getwalletinfo return expected wallet info")
            ...
            # Test beticoin-cli -generate with -rpcwallet in multiwallet mode.
