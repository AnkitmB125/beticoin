...
By default, beticoind will dump mempool on shutdown and
...
class MempoolPersistTest(beticoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent beticoind from writing mempool.dat to disk. Verify that `savemempool` fails")
